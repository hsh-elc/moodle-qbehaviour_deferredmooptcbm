 ...
 * feedback with certainty based marking behaviour for MooPT questions.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbehaviour_deferredmooptcbm_renderer extends qbehaviour_renderer {
    ...
    public function controls(question_attempt $qa, question_display_options $options) {
        $a = new stdClass();
        $a->help = $this->output->help_icon('certainty', 'qbehaviour_deferredmooptcbm');
        ...
        return html_writer::tag('div', get_string('howcertainareyou', 'qbehaviour_deferredmooptcbm', $a),
    ...
    public function marked_out_of_max(question_attempt $qa, core_question_renderer $qoutput,
        ...
        return get_string('weightx', 'qbehaviour_deferredmooptcbm', $qa->format_fraction_as_mark(
    ...
    public function mark_out_of_max(question_attempt $qa, core_question_renderer $qoutput,
            question_display_options $options) {
        return get_string('cbmmark', 'qbehaviour_deferredmooptcbm', $qa->format_mark($options->markdp)) .
