...
/**
 * Strings for component 'qbehaviour_deferredmooptcbm', language 'en'.
 *
 * @package    qbehaviour
...
$string['pluginname'] = 'Deferred feedback with CBM for Moodle Programming Task (MooPT)';
$string['privacy:metadata'] = 'The MooPT deferred feedback with CBM question behaviour plugin does not store any personal data.';
